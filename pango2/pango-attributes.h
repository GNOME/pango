...
#define PANGO2_ATTR_TYPE(num, value, affects, merge) (PANGO2_ATTR_VALUE_##value | (PANGO2_ATTR_AFFECTS_##affects << 8) | (PANGO2_ATTR_MERGE_##merge << 12) | (num << 16))
...
{
  PANGO2_ATTR_INVALID,
  PANGO2_ATTR_LANGUAGE             = PANGO2_ATTR_TYPE ( 1, LANGUAGE, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_FAMILY               = PANGO2_ATTR_TYPE ( 2, STRING, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_STYLE                = PANGO2_ATTR_TYPE ( 3, INT, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_WEIGHT               = PANGO2_ATTR_TYPE ( 4, INT, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_VARIANT              = PANGO2_ATTR_TYPE ( 5, INT, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_STRETCH              = PANGO2_ATTR_TYPE ( 6, INT, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_SIZE                 = PANGO2_ATTR_TYPE ( 7, INT, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_FONT_DESC            = PANGO2_ATTR_TYPE ( 8, FONT_DESC, ITEMIZATION, ACCUMULATES),
  PANGO2_ATTR_FOREGROUND           = PANGO2_ATTR_TYPE ( 9, COLOR, RENDERING, OVERRIDES),
  PANGO2_ATTR_BACKGROUND           = PANGO2_ATTR_TYPE (10, COLOR, RENDERING, OVERRIDES),
  PANGO2_ATTR_UNDERLINE            = PANGO2_ATTR_TYPE (11, INT, RENDERING, OVERRIDES),
  PANGO2_ATTR_UNDERLINE_POSITION   = PANGO2_ATTR_TYPE (12, INT, RENDERING, OVERRIDES),
  PANGO2_ATTR_STRIKETHROUGH        = PANGO2_ATTR_TYPE (13, INT, RENDERING, OVERRIDES),
  PANGO2_ATTR_RISE                 = PANGO2_ATTR_TYPE (14, INT, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_SCALE                = PANGO2_ATTR_TYPE (15, FLOAT, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_FALLBACK             = PANGO2_ATTR_TYPE (16, BOOLEAN, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_LETTER_SPACING       = PANGO2_ATTR_TYPE (17, INT, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_UNDERLINE_COLOR      = PANGO2_ATTR_TYPE (18, COLOR, RENDERING, OVERRIDES),
  PANGO2_ATTR_STRIKETHROUGH_COLOR  = PANGO2_ATTR_TYPE (19, COLOR, RENDERING, OVERRIDES),
  PANGO2_ATTR_ABSOLUTE_SIZE        = PANGO2_ATTR_TYPE (20, INT, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_GRAVITY              = PANGO2_ATTR_TYPE (21, INT, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_GRAVITY_HINT         = PANGO2_ATTR_TYPE (22, INT, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_FONT_FEATURES        = PANGO2_ATTR_TYPE (23, STRING, SHAPING, ACCUMULATES),
  PANGO2_ATTR_PALETTE              = PANGO2_ATTR_TYPE (24, STRING, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_ALLOW_BREAKS         = PANGO2_ATTR_TYPE (25, BOOLEAN, BREAKING, OVERRIDES),
  PANGO2_ATTR_SHOW                 = PANGO2_ATTR_TYPE (26, INT, SHAPING, OVERRIDES),
  PANGO2_ATTR_INSERT_HYPHENS       = PANGO2_ATTR_TYPE (27, BOOLEAN, SHAPING, OVERRIDES),
  PANGO2_ATTR_OVERLINE             = PANGO2_ATTR_TYPE (28, INT, RENDERING, OVERRIDES),
  PANGO2_ATTR_OVERLINE_COLOR       = PANGO2_ATTR_TYPE (29, COLOR, RENDERING, OVERRIDES),
  PANGO2_ATTR_LINE_HEIGHT          = PANGO2_ATTR_TYPE (30, FLOAT, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_ABSOLUTE_LINE_HEIGHT = PANGO2_ATTR_TYPE (31, INT, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_TEXT_TRANSFORM       = PANGO2_ATTR_TYPE (32, INT, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_WORD                 = PANGO2_ATTR_TYPE (33, BOOLEAN, BREAKING, OVERRIDES),
  PANGO2_ATTR_SENTENCE             = PANGO2_ATTR_TYPE (34, BOOLEAN, BREAKING, OVERRIDES),
  PANGO2_ATTR_PARAGRAPH            = PANGO2_ATTR_TYPE (35, BOOLEAN, BREAKING, OVERRIDES),
  PANGO2_ATTR_BASELINE_SHIFT       = PANGO2_ATTR_TYPE (36, INT, ITEMIZATION, ACCUMULATES),
  PANGO2_ATTR_FONT_SCALE           = PANGO2_ATTR_TYPE (37, INT, ITEMIZATION, ACCUMULATES),
  PANGO2_ATTR_LINE_SPACING         = PANGO2_ATTR_TYPE (38, INT, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_SHAPE                = PANGO2_ATTR_TYPE (39, POINTER, ITEMIZATION, OVERRIDES),
  PANGO2_ATTR_EMOJI_PRESENTATION   = PANGO2_ATTR_TYPE (40, INT, ITEMIZATION, OVERRIDES),
} Pango2AttrType;
